        ...
        <div className="container">
          <div className="row">
            <div className="col-12">
              <div className="copy article__body">
                <p>
                  In these Terms of Use, any use of the words "you", "yours" or
                  similar expressions shall mean any user of this website and
                  the app whatsoever. Terms such as "we", "us, "our" or similar
                  expressions shall mean the Football Association Premier League
                  Limited.
                </p>
                <br />
                <p>
                  This website,{" "}
                  <a href="http://www.Prolisty.com/">www.Prolisty.com</a> (the
                  “Website”), and the Premier League mobile application (the
                  “App”) are operated by the Football Association Premier League
                  Limited, a company registered in England and Wales under
                  company number 02719699 with registered office at The Premier
                  League, Brunel Building, 57 North Wharf Road, London, W2 1HQ.
                  Our VAT number is 672 6255 22.
                </p>
                <br />
                <p>
                ...
                <p>
                  ...
                  [<a href="mailto:info@Prolisty.com">info@Prolisty.com</a>].
                </p>
                <br />
                <p>
                  ...
                  Fantasy game. You do not need to register to use the Website
                  or App.
                </p>
                <br />
                <p>
                  ...
                  your personal information in our Questions and Answers. You
                  can find a link here:{" "}
                  <a href="https://www.Prolisty.com/privacy-policy-child-q&amp;as">
                    link
                  </a>
                  .
                </p>
                <br />
                <h4 className="mt-3 mb-2">OTHER APPLICABLE TERMS</h4>
                <p>
                  These Terms of Use are additional to, and should be read in
                  conjunction with, our{" "}
                  <a
                    title="Link to Privacy Policy page"
                    href="https://www.Prolisty.com/privacy-policy"
                  >
                    Privacy Policy
                  </a>{" "}
                  and{" "}
                  <a
                    ...
                    href="https://www.Prolisty.com/cookie-policy"
                  >
                    Cookie Policy
                  </a>
                  .
                ...
                <br />
                <p>
                  If you are under 18, we have tried to explain these policies
                  for you in our Questions and Answers. You can find a link
                  here:{" "}
                  <a href="https://www.Prolisty.com/privacy-policy-child-q&amp;as">
                    link
                  </a>
                ...
                <br />
                <h4 className="mt-3 mb-2">CHANGES TO THESE TERMS OF USE</h4>
                <p>
                ...
                <br />
                <h4 className="mt-3 mb-2">CHANGES TO THE WEBSITE</h4>
                <p>
                ...
                <br />
                <h4 className="mt-3 mb-2">INTELLECTUAL PROPERTY RIGHTS</h4>
                <p>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    people for their private and personal use provided you
                    credit us as its source and add the Website address:{" "}
                    <a href="http://www.Prolisty.com/">www.Prolisty.com</a>. You
                    must draw their attention to these terms which also apply to
                    them; and
                  </li>
                  <li>
                    You may provide links to the Website provided they go to the
                    ...
                    the part of us where none exists.
                  </li>
                </ul>
                <br />
                <p>
                ...
                <p>
                  You may register for an Account. You are not permitted to
                  register multiple Accounts on the Website or App.
                </p>
                <br />
                <p>
                  In registering for an Account, you will be providing personal
                  data to the Premier League. Any personal data which you do
                  submit will be processed in accordance with the Premier
                  League’s Privacy Policy and in accordance with relevant data
                  protection legislation including the General Data Protection
                  Regulation (“GDPR”) and the Data Protection Act 2018. If you
                  are under 18, you can find out more about how we use your
                  personal information in our Questions and Answers, which is
                  available here:{" "}
                  <a
                    href="https://www.Prolisty.com/privacy-policy-child-Q&amp;as"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    link
                  </a>
                  . We will only share personal data in accordance with our
                  Privacy Policy or if required to do so by a competent
                  authority or court within the United Kingdom.
                </p>
                <br />
                <p>
                  You may (at your sole discretion) enable two factor
                  authentication on your Account. Two factor authentication
                  improves the security of users’ accounts. Before enabling two
                  factor authentication, we recommend that you read our guide on
                  two factor authentication which can be found here:{" "}
                  <a
                    href="https://www.Prolisty.com/news/2667341"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    link
                ...
                <ul>
                  ...
                  <li>
                    Maintaining the security of your Account and/or password
                    including (without limitation) by keeping passwords for your
                    Account secure, frequently changing your password and
                    keeping it confidential; and
                  </li>
                  <li>
                    Implementing two factor authentication on your Account.
                  </li>
                </ul>
                <h4 className="mt-3 mb-2">NO RELIANCE ON INFORMATION</h4>
                <p>
                ...
                <br />
                <h4 className="mt-3 mb-2">EXTERNAL LINKS</h4>
                <p>
                ...
                <br />
                <h4 className="mt-3 mb-2">VIRUSES</h4>
                <p>
                ...
                <br />
                <h4 className="mt-3 mb-2">YOUR LAWFUL USE OF THE WEBSITE</h4>
                <p>
                ...
                <br />
                <h4 className="mt-3 mb-2">LIMITATION OF LIABILITY</h4>
                <p>
                ...
                <br />
                <h4 className="mt-3 mb-2">GOVERNING LAW</h4>
                <p>
