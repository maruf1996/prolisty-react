...
import { openingHours, categories, locations } from "../../data/data";
...
import { GlobalDataTypefour, OpeningHour } from "../../data/types";
              ...
              <div className="main-sidebar">
                ...
                <div className="single-sidebar-widget">
                  ...
                  <div className="single-sidebar-widget-openning-hour">
                    <table className="table table-bordered">
                      <tbody>
                        {openingHours.map((item: OpeningHour) => (
                          <tr key={item?._id}>
                            <td>{item?.day}</td>
                            <td>{item?.time}</td>
                          </tr>
                ...
                <div className="single-sidebar-widget">
                  ...
                  <div className="single-sidebar-widget-category">
                    <ul>
                      {categories.map((cat: GlobalDataTypefour) => (
                        <li key={cat?._id}>
                ...
                <div className="single-sidebar-widget">
                  ...
                  <div className="single-sidebar-widget-location">
                    <ul>
                      {locations.map((loc: GlobalDataTypefour) => (
                        <li key={loc?._id}>
