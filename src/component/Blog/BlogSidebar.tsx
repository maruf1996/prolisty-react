...
import { sidebarCategories, recentPosts, sidebarTags } from "../../data/data";
import {
  GlobalDataTypeThree,
  recentPostType,
      ...
      <div className="main-sidebar">
        ...
        <div className="single-sidebar-widget mb-60">
          ...
          <ul className="single-sidebar-widget-list__item">
            {sidebarCategories.map((cat: sidebarCategoriesType) => (
              <li key={cat?._id}>
                <Link to="#!">
        ...
        <div className="single-sidebar-widget rp-widget mb-60">
          ...
          {recentPosts?.map((post: recentPostType) => (
        ...
        <div className="single-sidebar-widget tag-widget mb-60">
          ...
          <ul className="single-widget-tag">
            {sidebarTags?.map((tag: GlobalDataTypeThree) => (
              <li key={tag?._id}>
