...
import { FooterCategories, FooterLocation, FooterMenu } from "../../data/data";
...
const Footer = ({ title }: FooterProps) => {
  return (
    <footer className="footer1 fix">
      ...
      >
        {title === "layout-one" && <CtaOne title="home-one" />}
          ...
          <div className="row justify-content-between">
            ...
            <div className="col-xxl-auto col-xl-3 col-lg-4 col-md-5">
              <div className="footer1-widget__item">
                ...
                <ul className="footer1-widget__item-list">
                  {FooterCategories.map((item: GlobalDataTypeThree) => (
                    <li key={item?._id}>
            ...
            <div className="col-xxl-auto col-xl-3 col-lg-4 col-md-5">
              <div className="footer1-widget__item footer1-widget__item-2">
                ...
                <ul className="footer1-widget__item-list">
                  {FooterLocation?.map((location: GlobalDataTypeThree) => (
                    <li key={location?._id}>
            ...
            <div className="col-xxl-auto col-xl-3 col-lg-4 col-md-5">
              <div className="footer1-widget__item">
                ...
                <ul className="footer1-widget__item-list">
                  {FooterMenu?.map((menu: GlobalDataTypeThree) => (
                    <li key={menu?._id}>
                      <Link
